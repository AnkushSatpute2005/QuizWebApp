const quizData = {
    ...
    JS:[
        ...
        {
          question: "Which JavaScript feature allows function execution at a later time?",
    ...
    },
    {
        ...
        answers: ["Microsoft Word", "Windows OS", "Google Chrome", "Adobe Photoshop"],
        correct: "Windows OS",
    },
    {
    ...
    IOT:[
      {
        ...
        answers: ["Internet of Technology", "Internet of Things", "Internet of Tools", "Integrated of Things"],
        correct: "Internet of Things",
    },
    {
        question: "Which of the following is an example of an IoT device?",
        answers: ["Smartwatch", "Microwave Oven", "Washing Machine", "Calculator"],
        correct: "Smartwatch",
    },
    {
        question: "What type of communication is commonly used in IoT devices?",
        answers: ["Wired Communication", "Satellite Communication", "Wireless Communication", "Morse Code"],
        correct: "Wireless Communication",
    },
    {
        question: "Which of the following protocols is commonly used in IoT for low-power communication?",
    ...
    },
    {
        ...
        answers: ["High power consumption", "Limited internet connectivity", "Security and privacy", "All of the above"],
        correct: "All of the above",
    },
    {
        question: "Which communication technology is commonly used in smart home IoT systems?",
        answers: ["Bluetooth", "Zigbee", "Wi-Fi", "All of the above"],
        correct: "All of the above",
    },
    {
        question: "What kind of sensors are used in IoT devices to detect movement?",
        answers: ["Temperature sensors", "Motion sensors", "Light sensors", "Pressure sensors"],
        correct: "Motion sensors",
    },
    {
        question: "Which cloud computing model is widely used in IoT applications?",
        answers: ["IaaS", "PaaS", "SaaS", "All of the above"],
        correct: "All of the above",
    },
    {
        question: "Which of the following is **not** a benefit of IoT?",
        answers: ["Automation", "Real-time monitoring", "Reduced cybersecurity risks", "Smart decision-making"],
    ...
    {
        question: "Which network topology has a central hub that connects all devices?",
        answers: ["Star", "Bus", "Ring", "Mesh"],
        correct: "Star",
    },
    {
        question: "What does IP stand for in networking?",
        answers: ["Internet Protocol", "Interconnect Program", "Internal Process", "Internet Processing"],
        correct: "Internet Protocol",
    },
    {
        question: "Which device is used to forward data packets between computer networks?",
    ...
    },
    {
        ...
        answers: ["Transport Layer", "Network Layer", "Session Layer", "Data Link Layer"],
    ...
    },
    {
        ...
        answers: ["Local Access Network", "Large Area Network", "Local Area Network", "Linked Area Network"],
